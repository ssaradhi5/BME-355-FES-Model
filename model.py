...
def meanSquaredError(output_array, test_array, label):
...
# def mse():
  # mean squared error between literature data and simulated data
    ...
    meanSquaredError(test1_ret[1], a_inter, labels[0])
    meanSquaredError(test2_ret[1], b_inter, labels[1])
    meanSquaredError(test3_ret[1], c_inter, labels[2])
    meanSquaredError(test4_ret[1], d_inter, labels[3])
    meanSquaredError(test5_ret[1], e_inter, labels[4])
